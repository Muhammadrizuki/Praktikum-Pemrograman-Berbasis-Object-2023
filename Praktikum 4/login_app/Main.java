...
public class Main {
    ...
    private static void showRegisterMenu() {
         ...
         * diinput sebelumnya
         */
        profile.setNama_lengkap(fullName);
        profile.setUmur(age);
         ...
         */
        profile.setNama_panggilan(StringUtils.toNick(fullName));
    ...
    private static void showDetailUser(Profile profile) {
         ...
         */
        System.out.println(profile.getNama_lengkap());
        System.out.println(profile.getNama_panggilan());
        System.out.println(profile.getUmur());
        System.out.println(profile.getHobi());
    }
}
