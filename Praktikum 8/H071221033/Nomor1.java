...
// untuk membuat instance dari ExecutorService. Dalam kode di atas, kita menggunakan method Executors.newFixedThreadPool() 
// untuk membuat sebuah instance dari ExecutorService yang menggunakan thread pool dengan ukuran tetap.
...
public class Nomor1 {
    ...
    public Nomor1(int jumlahData, int nomorThread) {
    ...
    private class LoadDataTask implements Runnable {
        ...
        public void run() {
            ...
            // method yang mengembalikan waktu acak (s) yang dibutuhkan untuk memuat data dari sumber yang diberikan.
            ...
            // jika waktu muat data melebihi tasktime yaitu 4 maka akan dicetak request time out di console dan sourceid akan ditambahkan ke failed data
            if (taskTime > 4) {
    ...
    public static void main(String[] args) {
        Nomor1 dataLoader = new Nomor1(4, 3);
