...
public class Product<T> {
    ...
    public static void main(String[] args) {
        Product<Integer> product1 = new Product<>("Cimory Squeeze Blueberry", 10000, LocalDate.of(2023, 5, 7));
        Product<String> product2 = new Product<>("Japota Honey", "11000", LocalDate.of(2024, 12, 20));
        Product<Double> product3 = new Product<>("Downey", 15.7, LocalDate.of(2025, 4, 11));
